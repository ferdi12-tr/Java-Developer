...
public class Account {
    ...
    public static int generateCheckSum(String accountIdentifierNumber) { // this method generate the check sum bit according to card number (except last digit, which is check bit)
        int sum = 0;
        for (int i = 0; i < 15; i++) {
            int multiple;
